...
public final class  TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -759.4964299245568; // y position of the parallel encoder (in tick units)
        public double perpXTicks = 2047.5651801426586; // x position of the perpendicular encoder (in tick units)
    }
