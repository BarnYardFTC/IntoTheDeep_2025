...
public class LiftProps extends MotorProps{
    ...
    public LiftProps() {
        ...
        this.ENCODER_TO_CM = this.ENCODER_TO_DEGREE * (360 / (this.TOOTH_OF_FINAL_PART * CHAIN_SIZE / SLIDE_COUNT / 10));
    }
    ...
    public LiftProps(double CHAIN_SIZE, int SLIDE_COUNT, double ENCODER_RESOLUTION, double OUTER_GEAR_RATIO, int TOOTH_OF_FINAL_PART) {
        ...
        this.ENCODER_TO_CM = this.ENCODER_TO_DEGREE * ((this.TOOTH_OF_FINAL_PART * this.CHAIN_SIZE / this.SLIDE_COUNT / 10) / 360);
    }
