...
public class RedSpecimen5Park extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        Action collectFifth = ignitionSystem.actionBuilder(RedSpecimenCoordinates.getScore3())
                .strafeToConstantHeading(RedSpecimenCoordinates.getIntake().position).build();

        Action scoreFifth = ignitionSystem.actionBuilder(RedSpecimenCoordinates.getIntake())
                .strafeToConstantHeading(RedSpecimenCoordinates.getScore5().component1()).build();

        Action park = ignitionSystem.actionBuilder(RedSpecimenCoordinates.getScore5())
