...
public class BlueSampleCoordinates {
    ...
    public static double scoreY1 = 46;
    public static double scoreX2 = 52;
    public static double scoreY2 = 47.5;
    public static double scoreX3 = 52;
    public static double scoreY3 = 51;
    public static double scoreX4 = 52.5;
    public static double scoreY4 = 49.2;
    public static double intake2X = 48.8;
    public static double intake2Y = 40;
    public static double intake3X = 56.75;
    public static double intake3Y = 40;
    public static double intake4X = 51.6;
    public static double intake4Y = 35;
