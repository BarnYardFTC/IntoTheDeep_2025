...
public class BlueSampleCoordinates {
    ...
    public static double scoreY2 = 46.8;
    public static double scoreX3 = 51;
    public static double scoreY3 = 52;
    public static double scoreX4 = 53.25;
    public static double scoreY4 = 52;
    public static double intake2X = 49.5;
    ...
    public static double intake4Y = 37.4;
