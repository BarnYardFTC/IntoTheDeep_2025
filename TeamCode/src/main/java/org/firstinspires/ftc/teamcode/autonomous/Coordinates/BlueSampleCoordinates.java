...
public class BlueSampleCoordinates {
    ...
    public static double scoreX1 = 55;
    public static double scoreY1 = 52.25;
    public static double scoreX2 = 50;
    public static double scoreY2 = 54;
    public static double scoreX3 = 50.5;
    public static double scoreY3 = 53.25;
    public static double scoreX4 = 48.75;
    public static double scoreY4 = 56.5;
    public static double intake2X = 46.5;
    public static double intake2Y = 48.75;
    public static double intake3X = 54;
    public static double intake3Y = 48.5;
    public static double intake4X = 51;
    public static double intake4Y = 41.5;
