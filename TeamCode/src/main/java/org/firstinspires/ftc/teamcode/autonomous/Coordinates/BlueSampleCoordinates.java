...
public class BlueSampleCoordinates {
    ...
    public static double scoreX3 = 50;
    public static double scoreY3 = 56;
    public static double scoreX4 = 46;
    public static double scoreY4 = 48;
    public static double intake2X = 44;
    public static double intake2Y = 50.5;
    public static double intake3X = 56;
    public static double intake3Y = 50.5;
    ...
    private static final double intake2PoseHeading = Math.toRadians(265);
