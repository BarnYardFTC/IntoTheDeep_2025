...
public class BlueSampleCoordinates {
    ...
    public static double scoreX1 = 57.5;
    public static double scoreY1 = 45.45;
    public static double scoreX2 = 52.15;
    public static double scoreY2 = 49.7;
    public static double scoreX3 = 51.7;
    public static double scoreY3 = 49.45;
    public static double scoreX4 = 50;
    public static double scoreY4 = 48.8;
    public static double intake2X = 49.7;
    public static double intake2Y = 41.4;
    public static double intake3X = 56.45;
    public static double intake3Y = 41.75;
    public static double intake4X = 52.22;
    public static double intake4Y = 34.75;
